...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Matrix[/B][/COLOR]Wizard'
BUILDERNAME = 'MatrixWizard'
EXCLUDES = [ADDON_ID, 'repository.matrix']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://dundas56.000webhostapp.com/matrix/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Matrix[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Matrix[/B][/COLOR]Wizard'
